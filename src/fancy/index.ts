...
const fancy: Registry = {
  ...
  "float": {
    ...
    "type": "components:fancy",
    "files": [
      "@/fancy/components/blocks/float.tsx"
    ],
    component: React.lazy(
      () => import('@/fancy/components/blocks/float'))
  },
  "screensaver": {
    "name": "screensaver",
    "type": "components:fancy",
  ...
  "parallax-floating": {
    ...
    "type": "components:fancy",
    "files": [
      "@/fancy/components/image/parallax-floating.tsx"
    ],
    component: React.lazy(
  ...
  "spotify-played": {
    ...
    "type": "components:fancy",
    "files": [
      "@/fancy/components/widget/spotify-played.tsx"
    ],
    component: React.lazy(
      () => import('@/fancy/components/widget/spotify-played'))
  }
};
...
const example: Registry = {
  ...
  "float-demo": {
    ...
    "type": "components:example",
    "files": [
      "@/fancy/examples/blocks/float-demo.tsx"
    ],
    component: React.lazy(
  ...
  "float-offset-demo": {
    ...
    "type": "components:example",
    "files": [
      "@/fancy/examples/blocks/float-offset-demo.tsx"
    ],
    component: React.lazy(
  ...
  "parallax-floating-demo": {
    ...
    "type": "components:example",
    "files": [
      "@/fancy/examples/image/parallax-floating-demo.tsx"
    ],
    component: React.lazy(
  ...
  "text-rotate-dynamic-options-demo": {
    "name": "text-rotate-dynamic-options-demo",
    "type": "components:example",
    "files": [
      "@/fancy/examples/text/text-rotate-dynamic-options-demo.tsx"
    ],
    component: React.lazy(
      () => import('@/fancy/examples/text/text-rotate-dynamic-options-demo'))
  },
  "text-rotate-multiline-demo": {
    "name": "text-rotate-multiline-demo",
    "type": "components:example",
    "files": [
      "@/fancy/examples/text/text-rotate-multiline-demo.tsx"
    ],
    component: React.lazy(
  ...
  "text-rotate-step-demo": {
    ...
    "type": "components:example",
    "files": [
      "@/fancy/examples/text/text-rotate-step-demo.tsx"
    ],
    component: React.lazy(

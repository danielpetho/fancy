    ...
    return (
        <div className="w-full h-full bg-[#fefefe]">
            <DragElements dragElastic={0.1} className="p-40">
                <div className="text-[150px] font-mono text-[#f0be59] rotate-[4deg]">
                    ✹
                </div>
                ...
                <div className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#4543c6] to-[#f0be59] rotate-[-12deg]">
                    AWESOME
                </div>

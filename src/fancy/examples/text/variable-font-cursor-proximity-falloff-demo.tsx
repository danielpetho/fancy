...
export default function Preview() {
  ...
  return (
    <div
      className="w-full h-full rounded-lg items-center justify-center font-overusedGrotesk p-24 bg-background cursor-pointer relative overflow-hidden"
      ref={containerRef}
    >
      ...
      <div className="w-full h-full items-center justify-center grid text-justify">
        <VariableFontCursorProximity
          ...
          className="leading-tight text-justify text-lg text-[#ff5941]"

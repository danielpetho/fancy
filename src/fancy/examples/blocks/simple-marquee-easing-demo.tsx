  ...
  return (
    ...
    >
      <div className="h-full top-0 w-full flex flex-row items-start">
          <div className="w-2/4 px-16 h-full items-center justify-center flex flex-col space-y-8 order-2">
            <h1 className="text-white font-calendas text-4xl tracking-tight">Welcome Back!</h1>
            
            <div className="space-y-4">
              <div className="space-y-1">
                <input 
                  type="email"
                  className="w-full bg-transparent border border-white rounded-lg px-4 py-2 text-white font-overusedGrotesk focus:outline-none focus:border-white"
                  placeholder="Email"
                />
              </div>
              ...
              <button className="w-full bg-white text-black font-overusedGrotesk font-medium py-2 rounded-lg hover:bg-neutral-200 transition-colors">
                Sign In
              </button>

              <p className="text-neutral-400 text-sm text-center">
                Don't have an account?{" "}
                <a href="#" className="text-white hover:text-neutral-200">Sign up</a>
              </p>
            </div>
          </div>
        <div className="w-2/4 h-full justify-end flex flex-row space-x-4 px-4 -mt-10 order-1">
          <SimpleMarquee
            className="h-full"
            baseVelocity={25}
            repeat={4}

...
const MarqueeItem = ({ children }: { children: React.ReactNode }) => (
  <div className="mx-4 hover:scale-105 cursor-pointer duration-300 ease-in-out">{children}</div>
)
...
export default function SimpleMarqueeDemo() {
  ...
  return (
    <div className="flex w-full h-full relative justify-center items-center flex-col bg-black overflow-auto" ref={(node) => setContainer(node)}>
      ...
      <div className="absolute h-[200%] top-0 w-full justify-center items-center flex flex-col space-y-4" >
        <SimpleMarquee
          className="w-full"
          baseVelocity={8}
          repeat={4}

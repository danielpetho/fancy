...
<CodeBlockWrapper
  language="bash"
>{`npm install tailwindcss@latest motion`}</CodeBlockWrapper>
...
<CodeBlockWrapper language="bash">{`npx shadcn@latest add "https://fancycomponents.dev/r/component-name.json"`}</CodeBlockWrapper>

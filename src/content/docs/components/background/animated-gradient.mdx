...
<Step>Add this hook for querying the dimensions of an element:</Step>
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>Speed of the animation (this is somewhat an arbitrary number, refer tothe source code for more details)</TableCell>
    </TableRow>
    <TableRow>

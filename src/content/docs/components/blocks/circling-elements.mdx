...
The animation is done with only a few animation keyframes, as you can see in the css config above.

## Examples

### Easing

You can set custom easings for the animation, as you can see in this demo.

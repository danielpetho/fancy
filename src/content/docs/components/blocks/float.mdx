...
By default, multiple Float components will move in unison. Use the `timeOffset` prop to create more organic movement, as demonstrated below:
...
<Table>
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell>Offset to stagger animations between multiple instances</TableCell>
    </TableRow>
    <TableRow>

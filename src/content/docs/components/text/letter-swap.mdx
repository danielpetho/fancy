...
<InstallBlockWrapper language="bash">{`npx shadcn@latest add "https://fancycomponents.dev/r/letter-swap-forward-anim.json"`}</InstallBlockWrapper>
...
<CodeBlockWrapper language="bash">{`npx shadcn@latest add "https://fancycomponents.dev/r/letter-swap-pingpong-anim.json"`}</CodeBlockWrapper>

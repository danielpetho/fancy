...
<InstallTabs command="shadcn add @fancy/underline-center" npx />
...
<InstallTabs command="shadcn add @fancy/underline-comes-in-goes-out" npx />
...
<InstallTabs command="shadcn add @fancy/underline-goes-out-comes-in" npx />

...
The performance impact of the animation increases with the length and complexity of the path. For optimal performance, especially if you're using multiple instances. Keep an eye on the perf :).

...
<CodeBlockWrapper language="bash">{`npx shadcn@latest add "https://fancycomponents.dev/r/underline-center.json"`}</CodeBlockWrapper>
...
<CodeBlockWrapper language="bash">{`npx shadcn@latest add "https://fancycomponents.dev/r/underline-comes-in-goes-out.json"`}</CodeBlockWrapper>
...
<CodeBlockWrapper language="bash">{`npx shadcn@latest add "https://fancycomponents.dev/r/underline-goes-out-comes-in.json"`}</CodeBlockWrapper>

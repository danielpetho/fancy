...
<CodeBlockWrapper language="bash">{`npx shadcn@latest add "https://fancycomponents.dev/r/variable-font-and-cursor.json"`}</CodeBlockWrapper>
...
<Step>Create this hook to query the cursor position's ref:</Step>

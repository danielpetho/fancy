...
Of course, you can achieve the same result by applying (other) transforms in a different order, and even playing with the transform origins. I apologise if it seems overcomplicated, this is how it made sense to me :).

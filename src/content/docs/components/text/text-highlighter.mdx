...
By default, it will highlight when the text comes into view.
...
By default, the animation will be triggered once the component is in the viewport. You can customize that behaviour by setting the `useInViewOptions` prop. For more information, check out the [useInView](https://www.react-spring.io/docs/hooks/use-in-view) documentation.

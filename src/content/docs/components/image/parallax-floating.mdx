...
<CodeBlockWrapper language="bash">{`npx shadcn@latest add "https://fancycomponents.dev/r/parallax-floating.json"`}</CodeBlockWrapper>
...
<CodeBlockWrapper language="typescript" className="mt-4">
  ...
  <FloatingElement depth={2}>
    <div className="absolute top-1/2 left-3/4 bg-primaryBlue-500" />
  </FloatingElement>
</Floating>`}
</CodeBlockWrapper>

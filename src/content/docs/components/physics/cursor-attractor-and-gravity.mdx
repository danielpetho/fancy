...
<CodeBlockWrapper language="bash">{`npx shadcn@latest add "https://fancycomponents.dev/r/cursor-attractor-and-gravity.json"`}</CodeBlockWrapper>
...
<CodeBlockWrapper language="bash">{`npm install matter-js @types/matter-js poly-decomp`}</CodeBlockWrapper>

<Step>Then, create two utility functions for the component.</Step>
...
<CodeBlockWrapper language="typescript" className="mt-2">

...
export function useMDXComponents(components?: MDXComponents): MDXComponents {
  return {
    h1: ({ className, ...props }: React.ComponentProps<"h1">) => (
      <h1
        className={cn(
          "scroll-m-24 text-4xl font tracking-tight py-2",
          className
        )}
        {...props}
      />
    ...
    h2: ({ className, ...props }: React.ComponentProps<"h2">) => (
      <h2
        className={cn(
          "scroll-m-20 text-3xl font-medium tracking-tight py-4",
          className
        )}
        {...props}
      />
    ...
    h3: ({ className, ...props }: React.ComponentProps<"h3">) => (
      <h3
        className={cn(
          "scroll-m-24 text-2xl font-medium tracking-tight py-4",
          className
        )}
        {...props}
      />
    ...
    h4: ({ className, ...props }: React.ComponentProps<"h4">) => (
      <h4
        className={cn(
          "scroll-m-20 text-xl font-bold tracking-tight py-4",
          className
        )}
        {...props}
      />
